...
(0, _jquery2.default)(document).ready(function () {
	...
	var teamSlider = (0, _jquery2.default)('.acc-slider');
	teamSlider.slick({
		slidesToShow: 3,
		arrows: true,
		prevArrow: '.acc-slider-prev',
		nextArrow: '.acc-slider-next'
	...
	// show dropdown list
	(0, _jquery2.default)('.acc-filter').on('click', function (event) {
		if ((0, _jquery2.default)(event.target).hasClass('acc-filter__button')) {
			(0, _jquery2.default)(this).toggleClass('acc-filter--active');
		}
	});

	// hide dropdown list after mouse leave
	(0, _jquery2.default)('.acc-filter').on('mouseleave', function () {
		(0, _jquery2.default)(this).removeClass('acc-filter--active');
	});

	// hide dropdown list after click on title
	(0, _jquery2.default)('.acc-filter__item').on('click', function () {
		(0, _jquery2.default)(this).toggleClass('acc-filter__item--active');
	});

	(0, _jquery2.default)('.acc-sort').on('click', function (event) {
		(0, _jquery2.default)(this).toggleClass('acc-sort--active');
	});

	(0, _jquery2.default)('.acc-sort__options li').on('click', function (event) {

		var text = (0, _jquery2.default)(this).text();
		(0, _jquery2.default)(this).closest('.acc-sort').find('.acc-sort__recent').text(text);
	});
});
